<!-- pdd-story-prompts: features_python.prompt, ingestion_service_python.prompt, screener_python.prompt -->
<!-- pdd-story-dev-units: features_python.prompt, ingestion_service_python.prompt, screener_python.prompt -->

# User Story: screen_incoming_pitches
